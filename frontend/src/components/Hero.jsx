...
const slides = [
  ...
  {
    image: '/assets/hero-slide-0.jpg',
    title: 'Café de especialidad',
    subtitle: 'Seleccionamos los mejores granos de Oaxaca y Veracruz',
    cta: { text: 'Conócenos', href: '#about' },
    overlay: 0.5,
  },
  {
  ...
  },
  {
    ...
    title: 'Tueste artesanal en casa',
    subtitle: 'Tostamos en pequeños lotes para resaltar los perfiles únicos de cada origen',
    cta: { text: 'Ver productos', href: '#products' },
    overlay: 0.45,
  },
  {
    image: '/assets/hero-events.png',
    title: 'Experiencias únicas',
    subtitle: 'Talleres, música en vivo y más en un ambiente acogedor',
    cta: { text: 'Ver eventos', href: '#events' },
    overlay: 0.5,
  },
  {
    image: '/assets/hero-slide-2.jpg',
    title: 'Pan horneado en casa',
    subtitle: 'Complementa tu experiencia Armandita con nuestro pan artesanal',
    cta: null,
    overlay: 0.45,
  },
  {
